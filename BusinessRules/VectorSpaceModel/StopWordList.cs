...
{
    /// <summary>
    /// Stop words list based on ftp://ftp.cs.cornell.edu/pub/smart/english.stop
    /// </summary>
    public class StopWordList
    {
        public static readonly string[] EnglishStopWords = { 
            ...
            "isn't", "it", "it'd", "it'll", "it's", "its", "itself", "j", "just", "k", "keep", "keeps", 
            ...
            "might", "more", "moreover", "most", "mostly", "much", "must", "my", "myself", "n", 
            ...
            "not", "nothing", "novel", "now", "nowhere", "o", "obviously", "of", "off", "often", "oh", 
        ...
        public static System.Collections.Hashtable EnglishStopWordsSet;
